...
/**
 * Позволяет надевать динамическую одежду обычным ПКМ по миру/предмету.
 * Одежда надевается в свой Curios-слот, а занятый слот заменяется с возвратом старой вещи в инвентарь.
 */
